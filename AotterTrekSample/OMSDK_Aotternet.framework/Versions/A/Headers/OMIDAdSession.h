 ...
 */
@interface OMIDAotternetAdSession : NSObject

/*!
 * @abstract The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDAotternetAdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDAotternetAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDAotternetAdSessionContext *)context
