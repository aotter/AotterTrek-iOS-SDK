 ...
 */
@interface OMIDAotternetAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDAotternetPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDAotternetPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDAotternetVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
