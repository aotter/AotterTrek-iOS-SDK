 ...
 */
@interface OMIDAotternetVideoEvents : NSObject
 ...
 * @see OMIDAdSession
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDAotternetAdSession *)session error:(NSError *_Nullable *_Nullable)error;
 ...
 */
- (void)loadedWithVastProperties:(nonnull OMIDAotternetVASTProperties *)vastProperties;
