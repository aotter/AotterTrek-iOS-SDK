...
- (void)videoManagerWithVideoView:(TKAdVideoView * _Nonnull)videoView didReceive:(enum AdEventType)event;
- (void)videoManagerWithVideoView:(TKAdVideoView * _Nonnull)videoView didReceiveBufferChange:(BOOL)isBufferPlayable;
...
SWIFT_CLASS("_TtC18AotterTrek_iOS_SDK13TKAdVideoView")
@interface TKAdVideoView : UIView
...
@interface TKAdVideoView (SWIFT_EXTENSION(AotterTrek_iOS_SDK))
- (void)stopVideo;
@end
