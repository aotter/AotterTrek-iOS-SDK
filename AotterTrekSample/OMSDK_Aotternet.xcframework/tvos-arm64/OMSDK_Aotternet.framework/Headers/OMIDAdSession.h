 ...
 */
@property(nonatomic, readonly) OMIDAotternetAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDAotternetAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDAotternetAdSessionContext *)context
