...
Pod::Spec.new do |spec|
  ...
  AotterTrek SDK for iOS developer. Contains Tracker and Ad features.
                   DESC

  spec.homepage     = "https://trek.aotter.net"
  ...
  spec.author             = "Aotter Inc."
  # Or just: spec.author    = "Aotter Inc."
  # spec.authors            = { "Aotter" => "ios@aotter.net" }
  # spec.social_media_url   = "https://twitter.com/Aotter"
  ...
  spec.source       = { :git => "https://github.com/aotter/AotterTrek-iOS-SDK.git", :tag => spec.version.to_s }
  ...
  spec.dependency "GoogleAds-IMA-iOS-SDK", "~> 3.12"
